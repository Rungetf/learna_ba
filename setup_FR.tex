...
%------------------------------------------------------------------------------
    ...
    \usepackage[labelfont=bf, labelsep=colon, format=plain, textfont=singlespacing]{caption}
    ...
    \usepackage{tikz}
    \usetikzlibrary{positioning, shapes, calc}  % use: above left of, etc
...
%------------------------------------------------------------------------------
    ...
    % ------------------- FR: Start own commands -------------------
    \usepackage{packages/math_commands}
    \usepackage{amsthm}
